...
export interface IProduct extends Document {
  name: string;
  slug: string;
  category: string; // Category.slug (e.g. blended-masalas)
  subCategory?: string;
  brand?: string;
...
const productSchema = new Schema<IProduct>(
  {
    ...
    shelfLife: { type: String, trim: true, maxlength: 200, default: '' },
    storageInstructions: { type: String, trim: true, maxlength: 500, default: '' },
